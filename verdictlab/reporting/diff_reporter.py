"""DiffReporter — comparison diff table for `verdictlab compare`.
...
from verdictlab.models.result import RunResult, TestResult
from verdictlab.reporting.base import Reporter
from verdictlab.runner.executor import compare_results
