"""Configuration loader for VerdictLab.

Provides GateConfig model and load/save functions for verdictlab.yaml.
"""
...
class GateConfig(BaseModel):
    """Top-level VerdictLab configuration model.

    Loaded from verdictlab.yaml (or verdictlab.toml in future).
    Defaults match what `verdictlab init` scaffolds.
    """
    baseline_dir: str = "verdictlab-baselines/"
