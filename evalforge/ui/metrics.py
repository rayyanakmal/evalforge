"""RAGAS-style canonical metric presets for the evalforge dashboard.

These are the industry-standard metric names from the RAGAS framework
(faithfulness, answer relevancy, context precision, context recall,
answer correctness). They map onto evalforge's existing RubricDimension
...
# into evalforge's existing RubricScorer unchanged.
